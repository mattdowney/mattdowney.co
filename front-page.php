...
<?php get_header(); ?>
			...
			<h1 class="greeting">
				...
				</span>I'm <a href="<?php bloginfo('wpurl'); ?>/about">Matt Downey</a>, a designer specializing in websites, apps, and products. Some of my clients include <a href="<?php bloginfo('wpurl'); ?>/foursquare">Foursquare</a>, <a href="<?php bloginfo('wpurl'); ?>/fpcu">FPCU</a>, <a href="<?php bloginfo('wpurl'); ?>/joey-the-cat">JTC</a>, MailChimp, <a href="<?php bloginfo('wpurl'); ?>/netpure">Netpure</a>, and Tumblr.
			</h1>
